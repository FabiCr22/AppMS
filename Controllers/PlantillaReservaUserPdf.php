...
class PlantillaReservaUserPdf extends FPDF
{
	function Header()
    {
        //Imagen
    ...
    function Body($reserva)
    {
        ...
        $this->Cell(60,10, utf8_decode('REGISTRO DE PARTICIPANTE EN SEMINARIOS'));
        ...
        //$this->MultiCell(124,5,utf8_decode($usuario[0]['Nombre_User']),0);
