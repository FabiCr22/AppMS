...
class PlantillaSeminarioPdf extends FPDF
{
	function Header()
    {
        //Imagen
    ...
    function Body($seminario)
    {
        ...
        $this->MultiCell(65,5,utf8_decode($seminario[0]['Titulo_Sem']));
        //$this->Ln();    //Salto de línea

        $this->SetXY(20, $this->GetY());
        $this->Cell(70,5,utf8_decode(''),0);
        $this->Image(utf8_decode('../'.$seminario[0]['Imagen_Sem']),20,85,68);
        ...
        $this->MultiCell(65,5,utf8_decode($seminario[0]['Descripcion_Sem']));
        ...
        $this->MultiCell(65,5,utf8_decode($seminario[0]['Fecha_Sem']));
        ...
        $this->MultiCell(65,5,utf8_decode($seminario[0]['Hora_Sem']));
        ...
        $this->MultiCell(65,5,utf8_decode($seminario[0]['Precio_Sem']));
    }
    function Footer()
    {
        //linea
