...
<section>
	<div class="login-card"><img src="assets/img/empresa/avatar_2x.png" class="profile-img-card">
		...
		<form class="form-signin" action="?controller=usuario&action=login" method="post">
		...
		<a href="?controller=usuario&action=register" class="forgot-password">¿No tienes una cuenta? <strong>Regístrate</strong><br></a>
	</div>
</section>