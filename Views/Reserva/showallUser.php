	...
	<div class="container">
		<div class="row">
		    <div class="col-lg-12 text-center">
		        <h2 class="text-uppercase section-heading">Seminarios de un Usuario</h2>
		        <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
		            <div class="container">
		            	<a href="#" class="navbar-brand">Usuarios</a>
		            	<button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
		                <div class="collapse navbar-collapse" id="navcol-1">
		                    <form target="_self" class="form-inline mr-auto" action="?controller=reserva&action=searchUser" method="post">
		                        <div class="form-group">
		                        	<label for="search-field"></label>
		                        	<input type="search" name="searchUser" placeholder="Usuario" class="form-control search-field" id="search-field" />
		                        	<button class="btn btn-primary" type="button"><i class="fa fa-search"></i> Buscar</button>
		                        </div>
		                    </form>
		                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#sems"><i class="fa fa-info-circle"></i> Info. Seminarios Usuario</button>
		                    <button type="button" class="btn btn-info" onclick="location.href='?controller=reserva&action=reservasUserPdf'"><i class="fa fa-file-pdf-o"></i> Seminarios Usuario PDF</button>
		                </div>
		            </div>
		        </nav>
		    </div>
				...
				<tbody id="sems">
					<?php foreach ($lista_reservas as $reserva) {?>
						<tr>
							...
							<td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#sem" data-whatever="@mdo"><i class="fa fa-info-circle"></i> Más Info.</button></td>
...
<div class="modal fade" id="sem" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      	<h4 class="modal-title" id="exampleModalLabel">Registro de Usuario en Seminario</h4>
...
<div class="modal fade" id="sems" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
      	<button type="button" class="btn btn-info" onclick="location.href='?controller=usuario&action=usuarioPdf&usuario=<?php echo $usuario->getId_User(); ?>'"><i class="fa fa-file-pdf-o"></i> Descargar Información PDF</button>
      	<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-close"></i> Cerrar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
