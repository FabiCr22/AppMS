	...
	<div class="container">
		<div class="row">
		    <div class="col-lg-12 text-center">
		        <h2 class="text-uppercase section-heading">Listado de Seminarios Disponibles</h2>
		        <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
		            <div class="container">
		            	<a href="#" class="navbar-brand">Seminarios</a>
		            	<button data-toggle="collapse" data-target="#navcol-1" class="navbar-toggler"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
		                <div class="collapse navbar-collapse" id="navcol-1">
		                    <form target="_self" class="form-inline mr-auto" action="?controller=reserva&action=searchregister" method="post">
		...
		<div class="table-responsive">
				...
				<tbody>
					<?php foreach ($lista_seminarios as $seminario) {?>
						<tr>
							...
							<td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#resregister"><i class="fa fa-check-square-o"></i> Registrarse</button></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
			...
			<nav aria-label="Page navigation example">
			  <ul class="pagination pagination-circle pg-blue justify-content-center">
			  	<li class='paginador-current btn btn-primary'>Página 1 de 1</li>
...
<div class="modal fade" id="resregister" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<p>¿Está seguro que desea registrarse en este seminario?</p>
      </div>
      <div class="modal-footer">
      	<button type="button" class="btn btn-info" onclick="location.href='?controller=reserva&action=save&Id_Sem=<?php echo $seminario->getId_Sem();?>'"><i class="fa fa-check-square-o"></i> Registrarse</button>
